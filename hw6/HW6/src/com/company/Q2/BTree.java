...
public class BTree<E extends Comparable<E>>  implements SearchTree<E> {
    // Nested class
    private int add_counter = 0,insert_counter=0;
    ...
    /**
     *
     * @param item Yerlestirilmesi istenen item
     * @param data localRoot data
     * @param f first
     * @param l last
     * @return index where should item put.
     */
    private int binarySearch(E item,E [] data,int f ,int l){
        for(int i =0;i<l;i++){
